...
Transaction.MAX_MONEY = 1680000000 * 1e8; // Gulden has 84M coins
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'http://guldencore.io/guide/transaction.html#serialization-checks';
 ...
 * and a slightly fancier format recognized by guldencore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a guldencore Address object. The
 * same is true for `script`, which can be a string or a guldencore Script.
 *
