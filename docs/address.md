# Gulden Address
Represents a bitcoin address. Addresses are the most popular way to make bitcoin transactions. See [the official Gulden Wiki](https://en.bitcoin.it/wiki/Address) for technical background information.
...
The errors are listed in the generated file in the [errors folder](https://github.com/guldenchain/guldencore/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/guldenchain/guldencore/tree/master/lib/errors/spec.js).
